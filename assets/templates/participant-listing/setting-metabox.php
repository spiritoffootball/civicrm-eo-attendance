...
<p class="description"><?php _e( 'The profile shown on the Participant Listing page. Select "Disabled" if you do not want participants to be shown.', 'civicrm-eo-attendance' ); ?></p>
